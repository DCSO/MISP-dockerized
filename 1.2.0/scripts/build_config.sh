...
func_check_if_vars_exists() {
  ...
  [ -z "${CONTAINER_SYSTEM_HTTP_PROXY-}" ]         && CONTAINER_SYSTEM_HTTP_PROXY=""
  [ -z "${CONTAINER_SYSTEM_HTTPS_PROXY-}" ]        && CONTAINER_SYSTEM_HTTPS_PROXY=""
  [ -z "${CONTAINER_SYSTEM_NO_PROXY-}" ]           && CONTAINER_SYSTEM_NO_PROXY="0.0.0.0"
