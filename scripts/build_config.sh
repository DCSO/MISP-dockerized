...
function default_container_version() {
  ...
  [ -z "$POSTFIX_CONTAINER_TAG" ] && POSTFIX_CONTAINER_TAG="1-alpine"
  [ -z "$MISP_CONTAINER_TAG" ] && MISP_CONTAINER_TAG="2.4.97-ubuntu"
  [ -z "$PROXY_CONTAINER_TAG" ] && PROXY_CONTAINER_TAG="1-alpine"
  [ -z "$ROBOT_CONTAINER_TAG" ] && ROBOT_CONTAINER_TAG="1-debian"
  [ -z "$MISP_MODULES_CONTAINER_TAG" ] && MISP_MODULES_CONTAINER_TAG="1-debian"
  ###
